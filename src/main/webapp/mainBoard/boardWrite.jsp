...
<link rel="stylesheet" type="text/css" href="css/main_after.css">
...
">
    ...
    <ul>
        ...
        <li>
          <h3>모집인원</h3>
          <input type="text" id="population" name="recruit_num" placeholder="모집인원 수">
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <h3>연락방법</h3>
        <input type="text" id="population" name="contact" placeholder="ex) 오픈채팅,구글폼,등">
    </li>
  </ul>
  <ul>
</ul>
...
<ul>
 ...
 <ul>
  <li>
        <input type="text" name="content" placeholder="내용을 입력해주세요" class="content_box">
  </li>
 </ul>
 ...
 <ul>
  <li style="
    margin-top: 10px;
">
        <input type="submit" value="등록" onclick="return boardCheck()" style="
    width: 800px;
">
